...
export const customerDocuments = pgTable(
  'customer_documents',
  {
    ...
    external_uploaded_at: timestamp('external_uploaded_at', {
      withTimezone: true,
    }),
...
export const socioDocuments = pgTable(
  'socio_documents',
  {
    id: uuid('id').defaultRandom().primaryKey(),
...
export type CustomerPartner = InferSelectModel<typeof socios>

export type NewCustomerPartner = InferInsertModel<typeof socios>

export type CustomerPf =
  InferSelectModel<typeof customerPfData>

export type NewCustomerPf =
  InferInsertModel<typeof customerPfData>
